...
from game.errors import DefaultError
...
async def main():
    ...
    try:
        ...
        kafka_map_producer = AIOGameMapKafkaProducer(output_queue, game, tick=game_tick)
        game_manager = KafkaGameManager(game, kafka_map_producer, output_queue)
